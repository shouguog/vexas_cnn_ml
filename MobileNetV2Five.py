...
#print("MobilleV2Test")
#train_data = torch.load('../datasetFiveTest/train_data_224.pt')
#test_data = torch.load('../datasetFiveTest/test_data_224.pt')
print("MobilleV2Test2")
train_data = torch.load('../datasetFiveTest2/train_data_224.pt')
test_data = torch.load('../datasetFiveTest2/test_data_224.pt')
...
for epoch in range(1, epoch+1):
    ...
    if epoch % 10 ==0:
        #torch.save(model, './models/MobileNetV2_Five_epoch_' + str(epoch) + '-vexas.pth')
        #torch.save(model, './models/MobileNetV2_FiveTest_epoch_' + str(epoch) + '-vexas.pth')
        torch.save(model, './models/MobileNetV2_FiveTest2_epoch_' + str(epoch) + '-vexas.pth')
print('Finished Training')

print(model)
#torch.save(model, './models/MobileNetV2-vexas-Five.pth')  # 保存模型
#torch.save(model, './models/MobileNetV2-vexas-FiveTest.pth')  # 保存模型
torch.save(model, './models/MobileNetV2-vexas-FiveTest2.pth')  # 保存模型
print("End")
